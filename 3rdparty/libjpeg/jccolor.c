...
typedef struct {
  ...
  CVINT32 * rgb_ycc_tab;		/* => table for RGB to YCbCr conversion */
} my_color_converter;
...
#define CBCR_OFFSET	((CVINT32) CENTERJSAMPLE << SCALEBITS)
...
rgb_ycc_start (j_compress_ptr cinfo)
{
  ...
  cconvert->rgb_ycc_tab = rgb_ycc_tab = (CVINT32 *)
...
{
  my_cconvert_ptr cconvert = (my_cconvert_ptr) cinfo->cconvert;
  register CVINT32 * ctab = cconvert->rgb_ycc_tab;
  register int r, g, b;
