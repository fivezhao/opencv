...
/* IOCTL request codes */
#define USB2_VIDEO_IOCTL_ENUM_FORMATS    0x1A00
#define USB2_VIDEO_IOCTL_ENUM_FRAMES     0x1A01
#define USB2_VIDEO_IOCTL_SET_FORMAT      0x1A02
#define USB2_VIDEO_IOCTL_GET_BUFFER_SIZE 0x1A03
#define USB2_VIDEO_IOCTL_SET_FRAME_INT   0x1A04
#define USB2_VIDEO_IOCTL_GET_TS          0x1A05    /* timestamp of the last video frame read */
