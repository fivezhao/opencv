...
set(CMAKE_CXX_FLAGS           "-I${CMAKE_BINARY_DIR} -I${CMAKE_SOURCE_DIR}/3rdparty/protobuf/src -DGOOGLE_PROTOBUF_HAS_CXX11_HASH ${CMAKE_CXX_FLAGS}")
set(CMAKE_C_FLAGS             "-I${CMAKE_BINARY_DIR} -I${CMAKE_SOURCE_DIR}/3rdparty/protobuf/src -DGOOGLE_PROTOBUF_HAS_CXX11_HASH ${CMAKE_C_FLAGS}" )
